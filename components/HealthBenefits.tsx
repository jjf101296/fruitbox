      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          <div className="inline-block px-4 py-2 bg-green-100 rounded-full">
            <span className="text-success font-semibold">Health Benefits</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group p-8 rounded-xl border border-neutral-200 hover:border-primary hover:shadow-lg transition-all duration-300 bg-white hover:bg-red-50"
            >
        ...
        {/* Bottom callout */}
        <div className="mt-16 bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-12 text-white text-center space-y-4">
          <h3 className="text-2xl font-bold">Ready to Transform Your Health?</h3>
